    ...
    <div className="mx-auto w-full bg-white border-t cyan-700/20  lg:px-8">
      <Disclosure as="div" className="p-2 lg:p-2" defaultOpen={false}>
        <DisclosureButton className="group flex w-full items-center justify-between">
          ...
          <ChevronDownIcon className="min-w-6 size-5 fill-cyan-950 group-data-[hover]:fill-cyan-600 group-data-[open]:rotate-180" />
        </DisclosureButton>
        <DisclosurePanel className="mt-4 text-sm/5 text-cyan-950">
          {body}
        </DisclosurePanel>
      </Disclosure>
    </div>
